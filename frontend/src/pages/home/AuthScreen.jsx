    ...
    return (
        <div className="hero-bg relative">
            <header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
                ...
                <Link to={'/login'} className='text-white bg-red-600 oy-1 px-2 rounded hover:bg-red-700' >
                    {"Sign In"}
                </Link>
            </header>
            {/*Signup Section */}
            <div className='flex flex-col items-center justify-center text-center py-40
                ...
                <form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleFormSubmit}>
                    ...
                    <button className='bg-red-600 text-xl lg:text-2xl px-2 
                                        lg:px-6 py-l md:px-2 rounded flex 
                                        justify-center items-center  hover:bg-red-700' >
                        {"Get Started"}
            ...
            <div className='py-10 bg-black text-white'>
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                    ...
                    <div className='flex-1 text-center md:text-left'>
                        ...
                        <p className='text-lg md:text-xl'>Watch on Smart TVs, PlayStation, Xbox, Chromecast, Apple TV, Blue-raay players, and more.</p>
                    </div>
                    {/* Right Panel
                    Need relative for z positioning*/}
                    <div className='flex-1 relative'>
                        ...
                        <video className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-1/2 z-10'
                            ...
                            muted
                            loop>
                            <source src='/hero-vid.m4v' type='video/mp4' alt='TV Animation' />
                        </video>
                    </div>
                </div>
            </div>
                ...
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
                    ...
                    <div className='flex-1'>
                        <div className='relative'>
                            ...
                            <div className='flex items-center gap-2 absolute bottom-5 left-1/2 
                                            -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border
                                            border-slate-500 rounded-md px-2'>
                ...
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                    ...
                    <div className='flex-1 relative overflow-hidden'>
                        ...
                        <video className='absolute top-2 left-1/2 -translate-x-1/2 h-4/6 z-10 max-w-[63%]'
                            ...
                            muted
                            loop>
                            <source src='/video-devices.m4v' type='video/mp4' alt='Device Animation' />
                        </video>
                    </div>
                </div>
            </div>
            ...
            <div className='py-10 bg-black text-white'>
                <div className='flex max-w-6xl mx-auto items-center justify-center 
                                flex-col-reverse md:flex-row px-4 md:px-2'>
                    {/* Left Panel */}
                    <div className='flex-1 relative'>
